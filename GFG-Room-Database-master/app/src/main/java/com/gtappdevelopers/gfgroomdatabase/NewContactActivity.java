...
public class NewContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseDescEdt = findViewById(R.id.idEdtSurname);
        courseDurationEdt = findViewById(R.id.idEdtTelephone);
        courseBtn = findViewById(R.id.idBtnSave);
        ...
        courseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.isEmpty() || courseDesc.isEmpty() || courseDuration.isEmpty()) {
                    Toast.makeText(NewContactActivity.this, "Please enter the valid course details.", Toast.LENGTH_SHORT).show();
                    return;
                }
